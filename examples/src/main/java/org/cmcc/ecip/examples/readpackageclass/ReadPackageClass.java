package org.cmcc.ecip.examples.readpackageclass;
...
public class ReadPackageClass {

	public static void main(String[] args) {
		List<String> result = getClazzName("org.cmcc.ecip.examples.readpackageclass", false);
		for (String c : result) {
