...
public class EcTools {
   ...
   public static CurveParam getCurveParam( int curveType ){
      ...
      if ( null == sCurveParams[curveType] ) {
         if (SecpEnum.SECP256K1.getType()
        		  == curveType) {
            sCurveParams[SecpEnum.SECP256K1.getType()] = new CurveParam( SecpEnum.SECP256K1.getType()
         ...
         else if (SecpEnum.SECP256R1.getType() == curveType) {
            sCurveParams[SecpEnum.SECP256R1.getType()] = new CurveParam( SecpEnum.SECP256R1.getType()
